...
def evaluate_email(
    ...
    system_message: Dict[str, str] = {
        "role": "system",
        "content": (
            f"As an AI assistant, your task is to help manage the Gmail inbox of {user_first_name} {user_last_name} "
            "by identifying promotional emails in their personal account. Your primary goal is to ensure that "
            "personal communications are not mistakenly filtered out.\n\n"
            'Respond with "True" if the email should be marked as read (promotional/automated), or "False" if it '
            ...
            "   - Emails requiring action (e.g., Venmo payments) should not be marked as read.\n"
            "   - Emails from critical sources (banks, government, schools) should remain unread.\n\n"
            "Examples of Promotional Emails to Mark as Read:\n"
            "- 'Your Weekly Newsletter from XYZ'\n"
            "- 'Flash Sale: 50% Off Today Only!'\n"
            "- 'Join Our Rewards Program'\n"
            "- Emails from 'noreply@' addresses\n\n"
            "Examples of Personal/Important Emails to Keep Unread:\n"
